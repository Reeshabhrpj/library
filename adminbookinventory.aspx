         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:Button class="form-control btn btn-primary" ID="Button4" runat="server" Text="Go" OnClick="LinkButton4_Click" />
                           </div>
                        </div>
                     </div>
                     <div class="col-md-8">
                  ...
                  <div class="row">
                     <div class="col-4">
                        <asp:Button ID="Button1" class="btn btn-lg d-grid gap-2 col-12 mx-auto btn-success" runat="server" Text="Add" OnClick="Button1_Click1" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button3" class="btn btn-lg d-grid gap-2 col-12 mx-auto btn-warning" runat="server" Text="Update" OnClick="Button3_Click3" />
                     </div>
                     <div class="col-4">
                        <asp:Button ID="Button2" class="btn btn-lg d-grid gap-2 col-12 mx-auto btn-danger" runat="server" Text="Delete" OnClick="Button2_Click2" />
                     </div>
                  </div>
               </div>
            </div>
